...
vim.keymap.set("n", "mm", harpoon_ui.toggle_quick_menu, { desc = "toggle quick menu" })
...
vim.keymap.set("n", "mi", harpoon_ui.nav_next, { desc = "next mark" })
vim.keymap.set("n", "mo", harpoon_ui.nav_prev, { desc = "previous mark" })
--harpoon end
